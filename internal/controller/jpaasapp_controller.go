...
//+kubebuilder:rbac:groups=hanweb.jpaas.deploy,resources=services,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=hanweb.jpaas.deploy,resources=services/status,verbs=get
